...
function App() {
  ...
  const changeColor = () => {
    ...
    if (theme === "dark") {
      style.backgroundColor = getComputedStyle(colorTheme).getPropertyValue(
        "--darkBk"
      );
      style.disable = getComputedStyle(colorTheme).getPropertyValue(
        "--darkDisable"
      );
      style.colorFirst = getComputedStyle(colorTheme).getPropertyValue(
        "--darkColorFirst"
      );
      style.colorSecond = getComputedStyle(colorTheme).getPropertyValue(
        "--darkColorSecond"
      );
      style.fontColor = getComputedStyle(colorTheme).getPropertyValue(
        "--darkFontColor"
      );
    } else {
      style.backgroundColor = getComputedStyle(colorTheme).getPropertyValue(
